...
function passvalid(){
    ...
    else if(emailIDorPhno!=userGivenMailorNum&&pass==userGivenpassword)
    {
        ...
        document.getElementById("status").innerHTML="Email id Or PhoneNUmber is wrong"
    }
    else{
        form[0].action="../HTML/html"
...
function passVis()
{
    ...
    document.getElementById("passvis").src="../Assets/Images/monkey.png";
